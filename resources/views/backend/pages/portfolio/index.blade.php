            ...
            <div class="card">
                <div class="card-header card-default">
                    <div class="float-right mt-10">
                        <a href="{{ route('admin.portfolio.create') }}" class="btn btn-primary btn-rounded box-shadow btn-icon"><i
                                class="fa fa-plus"></i> Yeni Portfolyo Ekle</a>
                    </div>
                    Portfolyolar
                    <p class="text-muted">Tüm portfolyolar burada listelenmektedir.</p>
                </div>
                ...
                <div class="card-body">
                    <table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
                        ...
                        @foreach($portfolios as $key => $portfolio)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                <td><img src="{{ asset($portfolio->image) }}" alt="{{ $portfolio->image }}" width="80"></td>
